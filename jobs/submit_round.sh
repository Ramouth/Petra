...
case $ROUND in
  ...
  3) N_SIM=200; SF_DEPTH=18; N_GAMES=500; LR=3e-4; EPOCHS=15; PATIENCE=5; W_SP=4:00; W_RV=6:00; W_GT=4:00 ;;
  4) N_SIM=400; SF_DEPTH=20; N_GAMES=500; LR=1e-4; EPOCHS=15; PATIENCE=5; W_SP=6:00; W_RV=8:00; W_GT=6:00 ;;
  5) N_SIM=400; SF_DEPTH=20; N_GAMES=500; LR=5e-5; EPOCHS=15; PATIENCE=5; W_SP=6:00; W_RV=10:00; W_GT=6:00 ;;
  6) N_SIM=400; SF_DEPTH=22; N_GAMES=500; LR=2e-5; EPOCHS=15; PATIENCE=5; W_SP=6:00; W_RV=12:00; W_GT=6:00 ;;
  *) echo "Unknown round: $ROUND (supported: 1-6)"; exit 1 ;;
esac

WORKERS=16
OPENING_BOOK="$DATA/openings_r2.txt"   # generated by gen_openings.py
